...
//		if (!problem.getName().equals("3x3 Basic Problem 09")) return "0";
		//***************************************************//
		...
		if (problem.getName().contains("2x")) {
			...
			RavensFigure oldB = problem.getFigures().get("B");
			RavensFigure oldC = problem.getFigures().get("C");
			RavensFigure oldD = problem.getFigures().get("D");
			RavensFigure oldE = problem.getFigures().get("E");
			RavensFigure oldF = problem.getFigures().get("F");
			RavensFigure oldG = problem.getFigures().get("G");
			RavensFigure oldH = problem.getFigures().get("H");
			...
			for (int i=1; i<= 6; i++) {
				RavensFigure oldI = problem.getFigures().get(Integer.toString(i));
